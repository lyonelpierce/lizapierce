                      ...
                      >
                        {sizes.map((size) => (
                          <div className="flex items-center" key={size.id}>
                            ...
                            <Label
                              htmlFor={size.id}
                              className="bg-zinc-900 border border-zinc-800 rounded-full px-4 h-8 flex items-center justify-center transition-all ease-in-out hover:scale-110 cursor-pointer hover:border-white peer-data-[state=checked]:border-white [&:has([data-state=checked])]:border-white"
                            >
                      ...
                      >
                        {materials.map((material) => (
                          <div className="flex items-center" key={material.id}>
                            ...
                            <Label
                              htmlFor={material.id}
                              className="bg-zinc-900 border border-zinc-800 rounded-full px-4 h-8 flex gap-1 items-center justify-center transition-all ease-in-out hover:scale-110 cursor-pointer hover:border-white peer-data-[state=checked]:border-white [&:has([data-state=checked])]:border-white"
                            >
                              <div
                                className={cn(
                                  "w-5 h-5 rounded-full bg-gradient-to-tr flex-none",
                                  {
